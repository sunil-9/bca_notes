# Model Evaluation: Understanding Performance Metrics in Machine Learning
...
The model is a **Decision Tree Classifier** trained to predict whether a person will buy a product based on their **Age** and **Income**. The dataset includes:
